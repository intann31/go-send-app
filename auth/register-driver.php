            ...
            if (mysqli_stmt_num_rows($check) > 0) {
                ...
                if (mysqli_stmt_execute($query_user)) {
                    ...
                    if (mysqli_stmt_execute($query_driver)) {
                        // 3. Set Session & Langsung ke Dashboard Driver (Arahkan keluar folder auth ke folder driver/utama)
                        $_SESSION['id_user'] = $user_id;
                        $_SESSION['nama_lengkap'] = $nama_lengkap;
                        $_SESSION['role'] = 'driver';

                        // Sesuaikan lokasi dashboard driver kamu di sini (misal: ../driver/dashboard.php atau ../dashboard-driver.php)
...
<div class="login-card">
    ...
    <div class="register-text">
        Sudah punya akun driver? <a href="login.php">Masuk di sini</a>
    </div>
</div>
