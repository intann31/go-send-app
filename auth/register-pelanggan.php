    ...
    if (!empty($nama_lengkap) && !empty($username) && !empty($email) && !empty($no_telepon) && !empty($password)) {
        ...
        if (mysqli_stmt_num_rows($check) > 0) {
            ...
            if (mysqli_stmt_execute($query)) {
                ...
                $error = "Gagal mendaftar akun pelanggan.";
            }
...
<head>
    ...
    <title>Daftar Pelanggan - GoSend</title>
...
<div class="auth-container">
    <div class="auth-card">
        ...
        <p class="subtitle">Buat akun pelanggan GoSend</p>
        ...
        <form method="POST">
            ...
            <button type="submit" class="btn-auth">Daftar Pelanggan</button>
        </form>
